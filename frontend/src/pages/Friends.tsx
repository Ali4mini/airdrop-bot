...
export const Friends = () => {
  ...
  return (
    <div className="flex-1 pb-24 pt-6 px-4">
      ...
      <div className="flex flex-col gap-3 mb-8">
        ...
        >
          ...
          <div className="flex flex-col relative z-10">
            <span className="font-bold text-white">Friend with Telegram Premium</span>
      ...
      {/* 3. LIST OF FRIENDS */}
      <div className="mb-4">
        <h2 className="font-bold text-lg mb-4 text-white">List of your friends ({FRIENDS.length})</h2>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-gray-400">Level {friend.level}</span>
                  </div>
                </div>
      ...
      <div className="fixed bottom-24 left-0 w-full px-4 z-20">
        <div className="flex gap-2">
          ...
          <motion.button 
            whileTap={{ scale: 0.95 }}
            className="flex-1 bg-white text-black font-black text-lg py-4 rounded-2xl shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:bg-gray-100 transition-colors"
          >
            Invite a friend
          </motion.button>
